...
public class Lab07
{
	...
	public static void loadData(MovieDB movies) throws IOException
	{
		...
		int movieAmount = Integer.parseInt(S.nextLine());
	...
	public static void getCommands(MovieDB movies)
	{
		...
		while (true)
		{
			...
			else if (choice.equals("2"))
			{
				...
				double gross = Double.parseDouble(scan.nextLine());
			...
			else if (choice.equals("3"))
			{
				...
				Movie theMovie = movies.findMovie(movieName);
				if (theMovie == null)
				{
					System.out.println(movieName + " was not found.");
				}
				else
				{
					System.out.println(theMovie.toString());
					// I'm not really sure if I'm supposed to do this?
				}
