/* CS 0401 Spring 2019 Java Example 6
...
{	
	public static void main (String [] args)
	{
	    ...
	    NumberFormat formatter = NumberFormat.getCurrencyInstance(Locale.US);
			...
			// will make more sense.   Note the line here and then
			// the use below.  Also note Section 3.10 of the text, where it
			// shows where it shows other ways to format output.  See ex6b for
		...
		//while (!test.toLowerCase().equals("no"))
		while (test.toLowerCase().equals("yes"))
		{
