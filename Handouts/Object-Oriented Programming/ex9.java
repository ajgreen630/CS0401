/* CS 0401 Spring 2019 Java Example 9
   ...
   StringBuilder class.  Note the comments in various places below.  Note in
...
public class ex9
{
	public static void showInfo(StringBuilder S)
	{
		...
		// Uncomment the line to see its (side) effect.  Note that this statement
		// is not changing variable S at all.  Rather, it is changing the object
		// that S refers to.
		//S.append("BOGUS");

		// Assign S to a new object -- value parames keep this from affecting
		// the argument, since it is changing the local variable S (the parameter)
	...
	public static void main (String [] args)
	{
		...
		showInfo(S1);	ex9.showInfo(S2);
		System.out.println();

		// The append() method is a MUTATOR.  Mutators alter the object in some way.
		// In this case, they are adding additional characters to the StringBuilder.
		S1.append("wacky");
