...
class Fish extends Animal
{
	...
	// Note call to super() here.  Since the name instance variable is private to
	// class Animal, we cannot directly initialize it here.  However, we CAN call
	// the super constructor which will initialize the name from the "Animal point
	// of view".  Since myWater does not exist in Animal, we must initialize that
	// variable explicitly here.
